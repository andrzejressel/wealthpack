...
export const FileDropzone = ({ file, onFileChange, isLoading = false, accept = "*", isValid = true, error = null }: FileDropzoneProps) => {
    ...
    return (
        <div
            ...
            onClick={handleClick}
        >
            <input type="file" ref={fileInputRef} onChange={handleFileInputChange} className="hidden" accept={accept} disabled={isLoading} />
